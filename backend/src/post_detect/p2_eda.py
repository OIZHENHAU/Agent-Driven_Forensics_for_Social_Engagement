...
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "outputs", "post")
...
def plot_histogram(df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_PATH,"all_histograms_features_post.png"))
...
def plot_boxplots(df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_PATH, "all_boxplots_features_post.png"))
...
def correlation_heatmap(df):
    ...
    plt.savefig(os.path.join(OUTPUT_PATH, "correlation_heatmap_post.png"))
...
def validate_log_normal(df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_PATH,"all_log_validation_features_post.png"))
